...
char* encontrarGeneroMaisAssistido(Serie *serie, int QuantidadeSeries)
{
    ...
    // Retorna o gênero mais assistido
    return serie[indiceGeneroMaisAssistido].Genero;
}

char* encontrarPlataformaMaisAssistida(Serie *serie, int QuantidadeSeries)
{
    // Cria um array para contar a quantidade de séries de cada plataforma
    ...
    // Retorna a plataforma mais assistida
    return serie[indicePlataformaMaisAssistida].Plataforma;
}
...
int main() {
    ...
    FILE *arquivo = fopen("arquivobinSeries.dat", "rb");
    ...
    FILE *arquivoCarregaHistorico = fopen("arquivobinHistorico.dat", "rb");
    ...
    while (menu !=9)
    {
        ...
        printf("Digite 9 para exibir a serie mais assistida\n");
        printf("Digite 10 para exibir a plataforma mais assinada\n");
      ...
      scanf("%d",&menu);
       ...
       switch (menu){
        ...
        case 9:
            ...
            char* generoMaisAssistido = encontrarGeneroMaisAssistido(serie, QuantidadeSeries);
            printf("O gênero mais assistido é: %s\n", generoMaisAssistido);
        break;


        case 10:
            char* plataformaMaisAssistida = encontrarPlataformaMaisAssistida(serie, QuantidadeSeries);
            printf("A plataforma mais assistida é: %s\n", plataformaMaisAssistida);
